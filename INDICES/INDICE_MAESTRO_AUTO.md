...
├── README.md (283 líneas)
├── backups/
│   ├── fundamentos.html (1522 líneas)
│   ├── pmo.html (1111 líneas)
│   ├── stack.html (989 líneas)
├── css/
│   ├── styles.css (205 líneas)
├── index.html (957 líneas)
├── js/
│   ├── main.js (153 líneas)
├── scripts/
│   ├── generate_progress.py (229 líneas)
│   ├── update_current_state.py (63 líneas)
│   ├── update_indices.py (201 líneas)
├── server.py (40 líneas)
```
...
|---------|-----------|--------|
| `auditar.md` | `.claude/commands/auditar.md` | 77 |
...
| `fundamentos.html` | `backups/fundamentos.html` | 1522 |
| `pmo.html` | `backups/pmo.html` | 1111 |
| `stack.html` | `backups/stack.html` | 989 |
| `styles.css` | `css/styles.css` | 205 |
| `index.html` | `index.html` | 957 |
| `main.js` | `js/main.js` | 153 |
| `generate_progress.py` | `scripts/generate_progress.py` | 229 |
| `update_current_state.py` | `scripts/update_current_state.py` | 63 |
| `update_indices.py` | `scripts/update_indices.py` | 201 |
| `server.py` | `server.py` | 40 |
